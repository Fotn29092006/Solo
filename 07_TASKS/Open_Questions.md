...
- Pending 2026-04-17: after the new Telegram diagnostics are loaded, determine whether the user's Telegram Desktop launch has SDK/WebApp missing, `tgWebAppData` missing, or `tgWebAppData` present but SDK `initData` missing.
