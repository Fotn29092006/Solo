...
- Pending 2026-04-17: use `Telegram bridge fallback` to determine whether ordinary inline browser scripts run in Telegram Desktop WebView, whether SDK/WebApp is available, and whether real `tgWebAppData` launch data is present.
