...
## Purpose
Navigation and startup memory for Solo System RPG.
...
This file is the vault entry point. It routes future Codex sessions through the graph memory system.

Required reading order for significant project work:

1. Root operational instructions: `AGENTS.md`; `CLAUDE.md` when working with Claude.
2. [[00_Project_Index]]
...
- Product: [[../01_PRODUCT/Vision]]
- UX/UI: [[../02_UX_UI/Screen_Map]], [[../02_UX_UI/Visual_Direction]]
- Systems: [[../03_SYSTEMS/Quest_System]], [[../03_SYSTEMS/XP_System]], [[../03_SYSTEMS/Adaptive_Mission_Engine]]
...
Raw blueprint source:

- `main.md` is historical source material. It does not override the curated vault unless a relevant insight is promoted into the proper active doc.
